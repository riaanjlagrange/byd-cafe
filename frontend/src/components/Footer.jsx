			...
			<div className="flex flex-col md:flex-row text-center ml-0 md:ml-20 md:text-left mt-10 md:mt-0 gap-20">
				...
				<nav> 
					<ul className="flex flex-col items-center md:items-start gap-3 w-40">
						...
						<li className="text-Mocha font-medium hover:text-Mocha-light underline transition-all">
							<NavLink to="/products" className="flex items-center justify-center gap-3"><MdRestaurantMenu />Products</NavLink>
						</li>
						<li className="text-Mocha font-medium hover:text-Mocha-light underline transition-all">
							<NavLink to="/services" className="flex items-center justify-center gap-3"><MdWorkspacesFilled />Services</NavLink>
						</li>
						<li className="text-Mocha font-medium hover:text-Mocha-light underline transition-all">
							<NavLink to="/bookings" className="flex items-center justify-center gap-3"><FaBookmark />Bookings</NavLink>
						</li>
						<li className="text-Mocha font-medium hover:text-Mocha-light underline transition-all">
							<NavLink to="/events" className="flex items-center justify-center gap-3"><MdEvent />Events</NavLink>
						</li>
						<li className="text-Mocha font-medium hover:text-Mocha-light underline transition-all">
